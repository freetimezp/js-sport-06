...
const blogData = [
    {
        id: 1,
        img: '/assets/images/blog/post1.jpg',
        date: 'March 10, 2024',
    ...
    {
        id: 2,
        img: '/assets/images/blog/post2.jpg',
        date: 'March 10, 2024',
        title: 'Maintain a perfect structure after workout',
        href: '',
    },
    {
        id: 3,
        img: '/assets/images/blog/post3.jpg',
        date: 'March 10, 2024',
        title: 'Maintain a perfect structure after workout',
        href: '',
    },
    {
        id: 4,
        img: '/assets/images/blog/post4.jpg',
        date: 'March 10, 2024',
        title: 'Maintain a perfect structure after workout',
        href: '',
    },
                    ...
                    >
                            ...
                            <SwiperSlide key={post.id}>
                                <div className='flex flex-col justify-start h-full max-w-[320px]
                                    ...
                                    <div className='flex flex-col items-start'>
                                        ...
                                        <Link href={post.href} className='hover:text-accent transition-all 
                                            duration-300'>
                                            <h5 className='h5'>
                                                {post.title}
                                            </h5>
                        ...
                        <SwiperNavButtons
                            ...
                            btnStyles='bg-accent text-white w-[56px] h-[56px] flex justify-center
                                items-center hover:bg-accent/80 transition-all duration-300 
                                hover:rounded-lg'
                            iconStyles='text-2xl'
                        />
                    </Swiper>
